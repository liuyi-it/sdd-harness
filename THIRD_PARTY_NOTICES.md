...
| Ponytail            | 14a0d79548d  | `14a0d79548d4de8fc2de95c1b94bb0de63a739d3` | MIT    | 仅改写最小正确实现与简洁性审查思想，不加载源码、包或 Hook |

Ponytail copyright: Copyright (c) 2026 DietrichGebert。
...
- Ponytail 来源、固定提交和适配范围见 `docs/upstream/ponytail.md`；运行时不会安装 Ponytail npm 包、Hook、MCP 或模式系统
