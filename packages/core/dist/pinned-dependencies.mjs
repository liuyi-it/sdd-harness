...
/** @type {const} */ ({
    codebaseMemoryMcp: {
        ...
        checksumManifest: "https://github.com/DeusData/codebase-memory-mcp/releases/download/v0.9.0/checksums.txt",
        checksumManifestSha256: "b7294616f22050124c8f2cf029cc9943e0b7d6e426fb9a0b95b1de9815c76e57",
    },
    openSpec: {
        name: "openspec",
