...
export type LoopDecision = "CONTINUE" | "PAUSE_FOR_AGENT" | "PAUSE_FOR_CLARIFICATION" | "PAUSE_FOR_HUMAN" | "FAIL" | "ABORT" | "DONE";
/** Loop 策略 */
export type LoopDecisionPolicy = "STRICT" | "BALANCED";
/** Loop 停止规则 */
export type LoopStoppingRule = "CLARIFYING" | "WAITING_AGENT" | "VERIFY_FAILED" | "REVIEW_FAILED" | "SECURITY_BLOCKED" | "STATE_CORRUPTED";
/** Loop 规范 */
