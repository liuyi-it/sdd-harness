...
export function decide(input) {
    if (!input.result.ok) {
        ...
        if (input.result.error?.code === "E_REVIEW_FAILED")
            return "PAUSE_FOR_HUMAN";
        if (input.result.error?.code === "E_SECURITY_BLOCKED")
            return "FAIL";
        if (input.result.error?.code === "E_STATE_CORRUPTED")
            return "FAIL";
        return "FAIL";
    }
...
//# sourceMappingURL=loop-decision.js.map